...
***************
'
    echo "An error occurred in runConcreteImageGalleryLocally.sh.sh . Exiting..." >&2
    exit 1
}
...
cd app
echo "Started concreteImageGallery. Do tail -f logs/concreteImageGalleryImage.log from "+$CURRENT_DIR
...
echo >&2 '
************
*** DONE runConcreteImageGalleryLocally.sh ***
************'